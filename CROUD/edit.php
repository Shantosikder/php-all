...
<body>
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		$sql = "UPDATE slist SET name = '$name', email = '$email', phone = '$phone', gender = '$gender' WHERE id = '$showidnumber'";
	 ...
	 <?php 
	 	...
	 	$sql = "SELECT * FROM slist WHERE id = '$id'";
	 	$data = $db->query($sql);
...
<div class="form-group">
	...
	<br><br>
	<a class="btn btn-info btn-block" href="studentDataShow.php">Show all Students Data </a>
